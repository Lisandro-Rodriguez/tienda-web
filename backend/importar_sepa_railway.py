"""
Script para importar el catalogo SEPA directo a Railway.
Ejecutar desde la carpeta backend con el venv activado:

    python importar_sepa_railway.py
"""

import csv
from sqlalchemy import create_engine, text

DATABASE_URL = "postgresql://postgres:GwYgVyKclWvKkarEqUJMrIJXAWtcKQjk@autorack.proxy.rlwy.net:41777/railway"
RUTA_CSV     = r"C:\Users\rodri\OneDrive\Documentos\Gestión Tienda Web\producto_sepa_completo.cvs"
BATCH_SIZE   = 1000
