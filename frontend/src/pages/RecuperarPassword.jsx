...
import { ArrowLeft, ChevronDown, Mail, AlertCircle } from 'lucide-react'
...
export default function RecuperarPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Mostrar el mensaje de error del backend directamente — son descriptivos
  ...
  return (
    <>
      <style>{`
        ...
        .rp-root { min-height:100vh; background:#0a0a0a; display:flex; align-items:center; justify-content:center; padding:1.5rem; font-family:'DM Sans',sans-serif; position:relative; }
        .rp-root::before { content:''; position:absolute; inset:0; background-image:linear-gradient(rgba(255,255,255,0.03) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,0.03) 1px,transparent 1px); background-size:48px 48px; pointer-events:none; }
        ...
        .rp-input { width:100%; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); border-radius:10px; padding:0.75rem 1rem; color:#f5f5f5; font-size:0.9rem; font-family:'DM Sans',sans-serif; outline:none; transition:border-color 0.2s; box-sizing:border-box; appearance:none; }
        ...
        .rp-error { display:flex; align-items:flex-start; gap:10px; background:rgba(239,68,68,0.08); border:1px solid rgba(239,68,68,0.2); border-radius:10px; padding:0.875rem 1rem; margin-bottom:1.25rem; }
        .rp-error-text { font-size:0.8rem; color:#fca5a5; line-height:1.5; }
            ...
            {!enviado ? (
                ...
                <form onSubmit={handleSubmit}>
                  <div className="rp-field">
                    ...
                    <div className="rp-select-wrap">
                      <select value={negocioId} onChange={e => { setNegocioId(e.target.value); setErrorMsg('') }}
                        className="rp-input" required>
              ...
              <div className="rp-success">
                ...
                <p className="rp-success-desc">
                  Te enviamos un link para restablecer la contraseña. Revisá tu bandeja de entrada y la carpeta de spam.
                </p>
